...
const Banner = () => {
  return (
    <div className="bg-gradient-to-r from-[#FFE6FD]/80 to-[#E0F8F5]/80 h-100 relative overflow-hidden">
      ...
      <div className="items-center flex justify-center">
        ...
        {/* background image */}
        <div className="flex justify-end absolute top-10">
          <img className="absolute left-0 top-10 w-48" src={imgLeft} alt="" />
          <img className="absolute right-10 top-10 w-48" src={imgRight} alt="" />
        </div>
      </div>
    </div>
  );
