    ...
    <div className="bg-gradient-to-r from-[#FFE6FD]/90 to-[#E0F8F5]/90 h-100 relative overflow-hidden">
      ...
      <div className="flex justify-center mt-8">
        <div className="join">
          ...
          <button className="btn join-item rounded-r-full bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg">
      ...
      <div className="items-center flex justify-center">
        <div className="flex gap-2 mt-8">
          ...
          <button className="btn border-2 border-[#632EE3] bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent">
            Post an Product
          </button>
        </div>
        {/* background image */}
